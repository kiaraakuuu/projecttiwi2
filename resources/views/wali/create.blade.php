        ...
        <form action="{{ route('wali.store') }}" method="post">
            ...
            <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="kelasSiswa" class="form-select" aria-label="Default select example" id="">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="namaWali" class="form-control" id="namaWali">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label for="alamatWali" class="col-sm-2 col-form-label">Alamat Wali</label>
                        <div class="col-sm-10">
                          <input type="text" name="alamatWali" class="form-control" id="alamatWali">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label for="noHpWali" class="col-sm-2 col-form-label">No Hp Wali</label>
                        <div class="col-sm-10">
                          <input type="text" name="noHpWali" class="form-control" id="noHpWali">
                        </div>
                      </div>
            </div>
