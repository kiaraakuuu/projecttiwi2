...
<html lang="en">
  ...
  <body>
    ...
    <div class="card mt-5">
        ...
        <form action="/editsiswa/{{$siswa->id}}" method="post">
            @csrf
            <div class="card-body">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="kelas" class="form-select" aria-label="Default select example" id="" value="{{$siswa->kelas}}" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="jenisKelamin" class="form-select" aria-label="Default select example" id="" value="{{$siswa->jenisKelamin}}" required>
                                <option selected>Open this select menu</option>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="date" name="tglLahir" class="form-control" id="tglLahir" value="{{$siswa->tglLahir}}" required>
                        </div>
                      </div>
            </div>
